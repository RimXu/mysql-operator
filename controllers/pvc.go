...
func (r *MysqlReconciler) QueryMysqlPVC(ns string, sc string, name string, ctx context.Context) error {
	//
...
// 创建PVC
func (r *MysqlReconciler) CreateMysqlPVC(ns string, sc string, name string, size string,ctx context.Context) error {
